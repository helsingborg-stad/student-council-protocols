...
namespace StudentCouncilProtocols\Module\Event;

class Event extends \Modularity\Module
{
    public $slug = 'event';
    public $supports = array();
    public $templateDir = STUDENTCOUNCILPROTOCOLS_PATH.'source/php/Module/Event/views/';
    public $template;
    public $lang;
    ...
    public function getTemplateData($template)
    {
        ...
        $class = '\StudentCouncilProtocols\Module\Event\TemplateController\\'.$template.'Template';
    ...
    {
        echo \StudentCouncilProtocols\Helper\RenderBlade::blade(
            'partials/list',
            $this->data(),
            $this->templateDir
        );
    ...
    public function getEvents($module_id, $page = 1, $useLimit = true)
    {
        ...
        $events = \StudentCouncilProtocols\Helper\QueryEvents::getEventsByInterval($params, $page);
    ...
    public function script()
    {
        wp_enqueue_script(
            'vendor-pagination',
            STUDENTCOUNCILPROTOCOLS_URL.'/source/js/vendor/simple-pagination/jquery.simplePagination.min.js',
            'jquery',
            false,
            true
        );
